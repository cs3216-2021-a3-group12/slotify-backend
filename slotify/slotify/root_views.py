    ...
    return Response(
        {
            ...
            "create new group": reverse("groups-create", request=request, format=format),
            "group details": reverse("groups-detail", request=request, format=format, args="1"),
            ...
            "tag details": reverse("tags-detail", request=request, format=format, args="1"),
            "list of categories": reverse("categories-list", request=request, format=format),
            "create new category": reverse("categories-create", request=request, format=format),
            "category details": reverse("categories-detail", request=request, format=format, args="1"),
            "list of members": reverse("members-list", request=request, format=format),
            "list pf memberships": reverse("memberships-list", request=request, format=format),
            "create new membership": reverse("memberships-create", request=request, format=format),
